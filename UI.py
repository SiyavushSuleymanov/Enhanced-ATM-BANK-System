...
class LoginPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        entered_username.grid(row=1, column=0, pady=10, padx=20)
        self.entered_username = tk.Entry(self, show="*")
        self.entered_username.grid(row=1, column=1, pady=10)

        entered_pin = tk.Label(self, text="PIN:")
        entered_pin.grid(row=2, column=0, pady=10, padx=20)
        self.entered_pin = tk.Entry(self, show="*")
        self.entered_pin.grid(row=2, column=1, pady=10)
